            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
              <div className="md:w-1/2 text-center md:text-left">
                ...
                <div className="flex justify-center md:justify-start gap-4 mb-8">
                  ...
                  <a href="https://drive.google.com/file/d/1guE1_BPjKD0e1W1cOlWD0cgBgRog3DMW/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-slate-200 dark:bg-slate-800 text-slate-800 dark:text-white font-semibold py-3 px-6 rounded-lg hover:bg-slate-300 dark:hover:bg-slate-700 transition-all shadow-lg transform hover:scale-105">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <ProjectCard01
                        ...
                        points={[
                            "Built high-authority contextual backlinks on cybersecurity & SaaS blogs",
                            "Linked homepage and core cloud security service pages",
                            "Used niche-relevant and branded anchor text strategy",
                            "Improved referral traffic and topical authority",
                            "Result: 📈 +32% organic traffic growth"
                        ]}
                    />
                    <ProjectCard02
                        title="Visme"
                        ...
                        points={[
                            ...
                            "Balanced branded and partial-match anchors",
                            "Increased visibility in creative SaaS searches",
                            "Result: 📈 +28% traffic growth"
                        ]}
                    />
                    <ProjectCard03
                        title="Loganix"
                        description="Loganix – SEO Services
"
                        ...
                        points={[
                            ...
                            "Used clean white-hat outreach techniques",
                            "Improved referral leads from SEO-focused audience",
                    ...
                    <ProjectCard04
                        ...
                        points={[
                            ...
                            "Used trust-focused anchors (KYC, identity verification)",
                            "Strengthened niche authority and referral traffic",
                            "Result: 📈 +30% traffic growth"
                        ]}
                    />
                    <ProjectCard05
                        title="Remofirst"
                        ...
                        points={[
                            ...
                            "Comparison-based content drove high-intent traffic",
                            "Strong branded visibility in HR SaaS niche",
                            "Result: 📈 +42% traffic growth"
                        ]}
                    />
                    <ProjectCard06
                        title="Mightycall"
                        ...
                        points={[
                            ...
                            "Targeted SMB & startup-focused audiences",
                            "Improved referral and demo-intent traffic",
                            "Result: 📈 +27% traffic growth"
                        ]}
                    />
                    <ProjectCard07
                        title="AML Ranger"
                        description="AML Ranger – Compliance Software"
                        icon={<TrendingUpIcon className="w-12 h-12 text-white" />}
                        gradient="from-indigo-500 to-purple-600"
                        tags={['White-Hat Outreach', 'Guest Posts', 'SaaS Backlinks', 'Competitor Analysis  ']}
                        points={[
                           "Secured backlinks from AML & risk-management websites",
                           "Product and homepage links placed contextually",
                           "Industry-specific anchor text optimization",
                           "Improved trust signals for compliance keywords",
                           "Result: 📈 +33% traffic growth"
                        ]}
                    />
                    <ProjectCard08
                        title="Avacado"
                        description="Avocado – SaaS Tool (Listicle + White-Hat)"
                        icon={<BotIcon className="w-12 h-12 text-white" />}
                        gradient="from-green-500 to-teal-600"
                        tags={['Industry Prospecting', 'Technical Niches', 'Niche Edits ', 'Real-time']}
                        points={[
                            "Featured in Top SaaS / Productivity Tools listicles",
                            "Homepage and feature pages linked naturally",
                            "100% white-hat, content-driven link building",
                            "Boosted brand discovery and referral sessions",
                            "Result: 📈 +38% traffic growth" 
                        ]}
                    />
                    <ProjectCard09
                        title="Hublead"
                        ...
                        points={[
                            ...
                            "Increased B2B referral traffic quality",
                            "Result: 📈 +29% traffic growth"
                        ]}
                    />
                    <ProjectCard10
                        title="Frilingue"
                        description="Frilingue – Language Learning Platform"
                        icon={<TrendingUpIcon className="w-12 h-12 text-white" />}
                        gradient="from-indigo-500 to-purple-600"
                        tags={['White-Hat Outreach', 'Guest Posts', 'SaaS Backlinks', 'Competitor Analysis  ']}
                        points={[
                            "Earned links from education & language blogs",
                            "Homepage and learning pages linked",
                            "Natural branded anchor usage",
                            "Improved international referral traffic",
                            "Result: 📈 +26% traffic growth"
                        ]}
                    />
                    <ProjectCard11
                        title="Eddy Pump"
                        ...
                        points={[
                            ...
                            "Industry-relevant anchor optimization",
                            "Improved B2B referral visibility",
                            "Result: 📈 +24% traffic growth"
                        ]}
                    />
                    <ProjectCard12
                        title="Shedplans"
                        ...
                        points={[
                            ...
                            "Buyer-intent content placements",
                            "Increased organic discovery",
                            "Result: 📈 +31% traffic growth"
                        ]}
                    />
                     <ProjectCard13
                        title="EasyCoop"
                    ...
                    />
                     <ProjectCard14
                        ...
                        points={[
                            ...
                            "Balanced commercial & branded anchors",
                            "Increased service-based referral traffic",
                            "Result: 📈 +22% traffic growth"
                        ]}
                    />
                   <ProjectCard15
                        title="Mobility"
                        description="Mobility – Tech & Mobility Solutions"
                        icon={<BriefcaseIcon className="w-12 h-12 text-white" />}
                        gradient="from-amber-500 to-orange-600"
                        tags={['Link Building', 'Guest Posts', 'Niche Edits', 'Competitor Analysis', 'SEO Strategy']}
                        points={[
                            "Built backlinks from tech & mobility-focused websites",
                            "Homepage and solution pages linked",
                            "Contextual SaaS placements",
                            "Improved brand visibility in mobility niche",
                            "Result: 📈 +34% traffic growth"
                        ]}
                    />
                </div>
            </div>
...
const ProjectCard01 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        ...
        <div className="p-6 flex flex-col flex-grow">
            ...
            <a href={codeLink || 'https://www.wiz.io/'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-1/2 bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-600 transition-all transform hover:scale-105">
...
const ProjectCard02 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
        <div className="p-6 flex flex-col flex-grow">
            ...
            <div className="mt-auto flex gap-4">
            <a href={codeLink || 'https://www.visme.co/'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-1/2 bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-600 transition-all transform hover:scale-105">
                    <CodeIcon className="w-5 h-5 mr-2"/> LINK
              </a>
...
const ProjectCard03 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
...
const ProjectCard04 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
        <div className="p-6 flex flex-col flex-grow">
            ...
            <div className="mt-auto flex gap-4">
                <a href={codeLink || 'https://ondato.com/'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-1/2 bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-600 transition-all transform hover:scale-105">
                    <CodeIcon className="w-5 h-5 mr-2"/> Link
                </a>
...
const ProjectCard05 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
        <div className="p-6 flex flex-col flex-grow">
            ...
            <div className="mt-auto flex gap-4">
            <a href={codeLink || 'https://www.remofirst.com/'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-1/2 bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-600 transition-all transform hover:scale-105">
                    <CodeIcon className="w-5 h-5 mr-2"/> LINK
              </a>
...
const ProjectCard06 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
        <div className="p-6 flex flex-col flex-grow">
            ...
            <div className="mt-auto flex gap-4">
                <a href={codeLink || 'https://www.mightycall.com/'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-1/2 bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-600 transition-all transform hover:scale-105">
                    <CodeIcon className="w-5 h-5 mr-2"/> Link
                </a>
...
const ProjectCard07 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
        <div className="p-6 flex flex-col flex-grow">
            ...
            <div className="mt-auto flex gap-4">
            <a href={codeLink || 'https://amlranger.ai/'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-1/2 bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-600 transition-all transform hover:scale-105">
                    <CodeIcon className="w-5 h-5 mr-2"/> LINK
              </a>
...
const ProjectCard08 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
        <div className="p-6 flex flex-col flex-grow">
            ...
            <div className="mt-auto flex gap-4">
            <a href={codeLink || 'https://avokaado.io/'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-1/2 bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-600 transition-all transform hover:scale-105">
                    <CodeIcon className="w-5 h-5 mr-2"/> LINK
              </a>
...
const ProjectCard09 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
        <div className="p-6 flex flex-col flex-grow">
            ...
            <div className="mt-auto flex gap-4">
            <a href={codeLink || 'https://www.hublead.io/'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-1/2 bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-600 transition-all transform hover:scale-105">
                    <CodeIcon className="w-5 h-5 mr-2"/> LINK
              </a>
...
const ProjectCard10 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
        <div className="p-6 flex flex-col flex-grow">
            ...
            <div className="mt-auto flex gap-4">
            <a href={codeLink || 'https://www.frilingue.ch/'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-1/2 bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-600 transition-all transform hover:scale-105">
                    <CodeIcon className="w-5 h-5 mr-2"/> LINK
              </a>
...
const ProjectCard11 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
...
const ProjectCard12 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
...
const ProjectCard13 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
...
const ProjectCard14 = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
...
const ProjectCard15  = ({ title, description, icon, gradient, tags, points, demoLink, codeLink }) => (
    <div className="bg-slate-900/80 rounded-xl shadow-xl overflow-hidden flex flex-col h-full border border-slate-700/50 transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-purple-500/20">
        <div className={`bg-gradient-to-br ${gradient} h-48 flex items-center justify-center`}>
            {icon}
        </div>
        <div className="p-6 flex flex-col flex-grow">
            ...
            <div className="mt-auto flex gap-4">
            <a href={codeLink || 'https://www.mobilityware.com/'} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center w-1/2 bg-slate-700 text-white font-semibold py-2 px-4 rounded-lg hover:bg-slate-600 transition-all transform hover:scale-105">
                    <CodeIcon className="w-5 h-5 mr-2"/> LINK
              </a>
